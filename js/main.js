...
document.getElementById("generate-btn").addEventListener("click", function() {
  ...
  var api_url = "https://business-card-qr.vercel.app/vercel-php/api.php?name=" + encodeURIComponent(name) + "&linkedin=" + encodeURIComponent(linkedinUrl) + "&github=" + encodeURIComponent(githubUrl);

  // Constrói a URL amigável para a página card.php usando o nome do usuário
  var card_url = "https://business-card-qr.vercel.app/vercel-php/card.php?name=" + encodeURIComponent(name);
