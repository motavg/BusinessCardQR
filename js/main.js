...
document.getElementById("generate-btn").addEventListener("click", function() {
  ...
  var api_url = "https://business-card-qr.vercel.app/api/api.php?name=" + encodeURIComponent(name) + "&linkedin=" + encodeURIComponent(linkedinUrl) + "&github=" + encodeURIComponent(githubUrl);
